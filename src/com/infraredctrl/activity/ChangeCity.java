...
public class ChangeCity extends Activity {
	...
	private TextView display, mChangeCityName;
	private String strProvince, strCity, strCounty;
	private ImageButton btChangeCityBack;
	...
	private int[] countyOfTaiWan = { R.array.gaoxiong_city_item, R.array.taibei_city_item };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_changecity);
		loadSpinner();
		btChangeCityBack = (ImageButton) findViewById(R.id.btChangeCityBack);
		btChangeCityBack.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				if (strProvince == null || strCity == null) {

				} else {
					Intent intent = new Intent(ChangeCity.this, TemperatureCharts.class);
					intent.putExtra("Province", strProvince);
					intent.putExtra("City", strCity);
					intent.putExtra("County", strCounty);
	...
	protected void onResume() {
		super.onResume();
		StatService.onResume(ChangeCity.this);
	}

	@Override
	protected void onPause() {
		StatService.onPause(ChangeCity.this);
		super.onPause();
	}
	...
	private void loadSpinner() {
		...
		mChangeCityName = (TextView) findViewById(R.id.mChangeCityName);
		mChangeCityName.setText("选择当前位置");
		display = (TextView) findViewById(R.id.display_edit);
