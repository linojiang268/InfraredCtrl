...
/**
 * CC3XSplashScreen Activity shows the Splash image for a given time and later
 * navigates the screen to the DeviceConfiguration Activity
 * {@link SetingWifiPage} The Activity is finished after the loading time is
 * done and starts next screen.
 * 
 * @author raviteja
 * 
 */
public class SettingCC3XSplashScreenTest extends Activity {
	/**
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CCX300Utils.setProtraitOrientationEnabled(SettingCC3XSplashScreenTest.this);
	...
	private void startTimer() {
		...
		splashTimer.postDelayed(new Runnable() {
			public void run() {
				Intent configIntent = new Intent(SettingCC3XSplashScreenTest.this, SettingCC3000WifiPageTest.class);
